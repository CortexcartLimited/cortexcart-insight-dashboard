...
const XIcon = () => <svg viewBox="0 0 24 24" className="h-5 w-5 mr-3" fill="currentColor"><path d="M18.901 1.153h3.68l-8.042 9.167L24 22.847h-7.362l-6.189-7.07L3.68 22.847H0l8.608-9.83L0 1.153h7.521l5.474 6.208L18.901 1.153zm-.742 19.13L5.08 2.6H3.254l15.85 19.68h1.826z"></path></svg>;
