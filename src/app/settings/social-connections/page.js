...
import Link from 'next/link'; // Assuming you might need Link
...
export default function SocialConnectionsPage() {
    ...
    useEffect(() => {
        // 1. Check for success/error messages from the redirect
        ...
        // 2. Fetch the latest connection statuses from our new API
    ...
    // Helper component for the connection button/status
    ...
    return (
        <Layout>
            <h2 className="text-3xl font-bold mb-4">Social Connections</h2>
